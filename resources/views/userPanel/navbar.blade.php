...
<head>
    ...
    <!-- Favicons -->
    <link href="{{asset('user_assets/assets/img/favicon.png')}}" rel="icon">
    <link href="{{asset('user_assets/assets/img/apple-touch-icon.png')}}" rel="apple-touch-icon">
    ...
    <link href="{{asset('user_assets/assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
...
<script src="{{asset('user_assets/assets/vendor/glightbox/js/glightbox.min.js')}}"></script>
