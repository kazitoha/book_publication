                        ...
                        <div class="row ">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                <div class="card-content">
                                    <h1 class="font-15">মোট প্রেস</h1>
                                    <h2 class="mb-3 font-18">{{ convertEnglishToBangla(PrintingPress::count()) }}</h2>
                ...
                <div class="card-statistic-4">
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                <div class="card-content">
                                    <h5 class="font-15"> মোট বই</h5>
                                    <h2 class="mb-3 font-18">{{ convertEnglishToBangla(BookStorage::count()) }}</h2>
                ...
                <div class="card-statistic-4">
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                <div class="card-content">
                                    <h5 class="font-15">মোট ক্লাস</h5>
                                    <h2 class="mb-3 font-18">{{ convertEnglishToBangla(Classes::count()) }}</h2>
                ...
                <div class="card-statistic-4">
                    <div class="align-items-center justify-content-between">
                        <div class="row ">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                <div class="card-content">
                                    <h5 class="font-15">মোট বিষয়</h5>
                                    <h2 class="mb-3 font-18">{{ convertEnglishToBangla(Subjects::count()) }}</h2>
